...
var capitalIcon = L.icon({
    iconUrl: 'libs/icons/capitol.png',
    iconSize: [29, 24],
    iconAnchor: [9, 21],
    popupAnchor: [0, -14]
});

var museumsIcon = L.icon({
    iconUrl: 'libs/icons/museum.png',
    iconSize: [29, 24],
    iconAnchor: [9, 21],
    popupAnchor: [0, -14]
});

var universitiesIcon = L.icon({
    iconUrl: 'libs/icons/uni.png',
    iconSize: [29, 24],
    iconAnchor: [9, 21],
    popupAnchor: [0, -14]
});
...
var citiesIcon = L.icon({
    iconUrl: 'libs/icons/place.png',
    iconSize: [29, 24],
    iconAnchor: [9, 21],
    popupAnchor: [0, -14]
});
var shopIcon = L.icon({
    iconUrl: 'libs/icons/shopIcon.png',
    iconSize: [29, 24],
    iconAnchor: [9, 21],
    popupAnchor: [0, -14]
});
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for(let i=0; i < results.length; i++){
              ...
              window = new Country(name, iso_a2, iso_a3, iso_n3, geoType, coordinates)
            }
    ...
    success: function(result) {
        ...
        if(result.status.name == "ok"){
          ...
          //  console.log(result);
            ...
            for (var i = 0; i < result.data.geonames.length; ++i) { //result.data.geonames[i].name
